from models.MRHA_Decoder import MRHADecoder
from models.MRHA_Encoder import MRHAEncoder
...
class DBAHNet(nn.Module):
    def __init__(self, emb_dim, in_dim, num_classes, depth, num_heads, window_size):
        ...
        self.mrha_encoder = MRHAEncoder(dim = emb_dim, in_dim = self.in_dim_encoder, depth = depth, 
                                        num_heads = num_heads, window_size = window_size)
        self.mrha_decoder = MRHADecoder(dim = 8*emb_dim, in_dim = self.in_dim_decoder, num_classes=num_classes,
